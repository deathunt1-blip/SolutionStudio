...
function refinementRequest(input:RefinementInput):LLMRequest {
 ...
 const payload={instructions:refinementInstructions,current:{filename:truncateUtf8(document.filename,500),parsed_title:truncateUtf8(parsed.title??'',450),canonical_title:truncateUtf8(document.title,450),
