...
export async function openDatabase(dataDir: string, databaseUrl?: string): Promise<Database> {
  ...
  for (const [version,filename] of [[2,'002_canonical_metadata.sql'],[3,'003_refinement.sql'],[4,'004_structured.sql'],[5,'005_external_sources.sql'],[6,'006_document_deduplication.sql'],[7,'007_projects.sql'],[8,'008_document_engine.sql'],[9,'009_requirement_workspace.sql'],[10,'010_knowledge_sections.sql'],[11,'011_retired_project_assets.sql']] as const) {
