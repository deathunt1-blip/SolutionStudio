...
import { ArrowRight, BellDot, BookOpen, Check, CheckCheck, ChevronDown, ChevronRight, CircleHelp, Copy, FolderInput, Inbox as InboxIcon, Layers3, LibraryBig, ListChecks, Menu, Plus, Settings2, ShieldCheck, Sparkles, Upload, X } from 'lucide-react';
...
const pageNames: Record<Page, string> = { inbox: '知识收件箱', library: '资料库', review: '待确认', settings: '分类与设置', refinement: '智能整理', duplicates: '重复资料' };
...
export default function App() {
  ...
  const navItems = [{ key: 'inbox' as const, title: '知识收件箱', Icon: InboxIcon, count: stats.data?.processing }, { key: 'library' as const, title: '资料库', Icon: LibraryBig, count: undefined }, { key: 'review' as const, title: '待确认', Icon: ListChecks, count: stats.data?.needsReview }, { key: 'refinement' as const, title: '智能整理', Icon: Sparkles, count: undefined }, { key: 'duplicates' as const, title: '重复资料', Icon: Copy, count: undefined }];
