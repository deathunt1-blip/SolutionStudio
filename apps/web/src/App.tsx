...
import { ArrowRight, BellDot, BookOpen, Check, CheckCheck, ChevronDown, ChevronRight, CircleHelp, FolderInput, Inbox as InboxIcon, Layers3, LibraryBig, ListChecks, Menu, Plus, Settings2, ShieldCheck, Upload, X } from 'lucide-react';
...
const pageNames: Record<Page, string> = { inbox: '知识收件箱', library: '资料库', review: '待确认', settings: '分类与设置' };
const currentPage = (): Page => { const value = window.location.hash.slice(1); return value in pageNames ? value as Page : 'inbox'; };
...
export default function App() {
  ...
  const navItems = [{ key: 'inbox' as const, title: '知识收件箱', Icon: InboxIcon, count: stats.data?.processing }, { key: 'library' as const, title: '资料库', Icon: LibraryBig, count: undefined }, { key: 'review' as const, title: '待确认', Icon: ListChecks, count: stats.data?.needsReview }];
